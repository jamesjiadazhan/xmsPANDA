do_wgcna <-
    function(feature_table_file = NA, class_labels_file = NA, X = NA, Y = NA, sigfeats = NA) {
        ...
        netclassA = suppressWarnings(blockwiseConsensusModules(multiExpr,
            power = power_val, minModuleSize = 10, deepSplit = 2,
        ...
        # tiff("module_preservation.tiff",width=2000,height=2000)
        # par(cex = 0.9)
        plotEigengeneNetworks_custom(MET, setLabels,
            marDendro = c(0, 2, 2, 1), marHeatmap = c(3, 3, 2, 1), zlimPreservation = c(0.5, 1), plotPreservation = "standard",
