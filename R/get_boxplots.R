get_boxplots <-
    function(X = NA, Y = NA, feature_table_file, parentoutput_dir, class_labels_file,
        ...
        match_col.opt = match(boxplot.col.opt, c(
        ...
        res <- suppressWarnings(suppressMessages(get_boxplots_child(
            X = X, Y = Y, feature_table_file = feature_table_file, parentoutput_dir = parentoutput_dir, class_labels_file = class_labels_file, boxplot.col.opt, alphacol = alphacol, newdevice = newdevice, cex.plots = cex.plots,
