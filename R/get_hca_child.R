get_hca_child <-
    function(feature_table_file, parentoutput_dir, class_labels_file, X = NA, Y = NA, heatmap.col.opt = "RdBu", cor.method = "spearman", is.data.znorm = FALSE, analysismode = "classification",
        ...
        class_df <- data.frame(
            factor_levels = classgroup_levels,
                    ...
                    if (is.data.znorm == FALSE) {
                        if (is.na(rowcolors) == FALSE) {
                            ...
                            h73 <- heatmap.2(data_m,
                                Rowv = as.dendrogram(hr), Colv = as.dendrogram(hc), col = heatmap_cols, scale = "row", key = TRUE,
                            ...
                            h73 <- heatmap.2(data_m,
                                Rowv = as.dendrogram(hr), Colv = as.dendrogram(hc), col = heatmap_cols, scale = "row",
                        ...
                        if (is.na(rowcolors) == FALSE) {
                            ...
                            h73 <- heatmap.2(data_m,
                                Rowv = as.dendrogram(hr), Colv = as.dendrogram(hc), col = heatmap_cols,
                            ...
                            h73 <- heatmap.2(data_m,
                                Rowv = as.dendrogram(hr), Colv = as.dendrogram(hc), col = heatmap_cols, scale = "none",
                    ...
                    if (col_samples == FALSE) {
                        if (is.data.znorm == FALSE) {
                            if (is.na(rowcolors) == FALSE) {
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = as.dendrogram(hr), Colv = NULL, col = heatmap_cols, scale = "row", key = TRUE,
                            ...
                            if (is.na(rowcolors) == FALSE) {
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = as.dendrogram(hr), Colv = NULL, col = heatmap_cols, scale = "none",
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = as.dendrogram(hr), Colv = NULL, col = heatmap_cols, scale = "none", key = TRUE,
                                    symkey = FALSE, density.info = "none", trace = "none", cexRow = cexRow, cexCol = cexCol,
                                    xlab = xlab_text, ylab = ylab_text, main = mainlab1, labRow = labRow.value, labCol = labCol.value, cex.main = 0.8
                                )
                    ...
                    if (hca_type == "samples" | hca_type == "oneway_samples") {
                        ...
                        if (col_samples == FALSE) {
                            if (is.data.znorm == FALSE) {
                                ...
                                par(omd = c(0, 1 - w, 0, 1), cex.main = 0.7)
                                h73 <- heatmap.2(data_m,
                                    Rowv = NULL, Colv = as.dendrogram(hc), col = heatmap_cols, scale = "row",
                                    key = TRUE, symkey = FALSE, density.info = "none", trace = "none", cexRow = cexRow,
                                ...
                                par(omd = c(0, 1 - w, 0, 1), cex.main = 0.7)
                                h73 <- heatmap.2(data_m,
                                    Rowv = NULL, Colv = as.dendrogram(hc), col = heatmap_cols, scale = "none", key = TRUE,
                                    symkey = FALSE, density.info = "none", trace = "none", cexRow = cexRow, cexCol = cexCol,
                                    xlab = xlab_text, ylab = ylab_text, main = mainlab1, labRow = labRow.value, labCol = labCol.value, cex.main = 0.8
                                )
                            ...
                            if (is.data.znorm == FALSE) {
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = NULL, Colv = as.dendrogram(hc), col = heatmap_cols, scale = "row", key = TRUE,
                                    symkey = FALSE, density.info = "none", trace = "none", cexRow = cexRow, cexCol = cexCol, xlab = xlab_text, ylab = ylab_text,
                        ...
                        if (col_samples == FALSE) {
                            if (is.data.znorm == FALSE) {
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = NULL, Colv = NULL, col = heatmap_cols, scale = "row", key = TRUE, symkey = FALSE,
                                    density.info = "none", trace = "none", cexRow = cexRow, cexCol = cexCol, xlab = xlab_text, ylab = ylab_text,
                                ...
                                h73 <- heatmap.2(data_m,
                                    Rowv = NULL, Colv = NULL, col = heatmap_cols, scale = "none", key = TRUE, symkey = FALSE,
